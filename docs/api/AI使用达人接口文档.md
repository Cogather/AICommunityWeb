...
| 3 | `/api/honor/leaderboard` | GET | 获取荣誉影响力排行榜（前10名） |
...
| 8 | `/api/honor/awards` | POST | 保存单个奖项 |
| 9 | `/api/honor/awards/{id}` | DELETE | 删除奖项 |
| 10 | `/api/honor/latest-winners` | GET | 获取最新获奖者列表（首页展示用） |
