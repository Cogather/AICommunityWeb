...
CREATE TABLE `t_new_honors_detail` (
  ...
  `honor_type` int(11) DEFAULT NULL COMMENT '荣誉类型 0：个人 1：团队',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='月度荣誉表';

CREATE TABLE `t_new_honors_flowers` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID，自增',
  `honor_id` varchar(30) NOT NULL COMMENT '荣誉ID',
  `flowers_user_id` varchar(30) DEFAULT NULL COMMENT '送花用户ID',
  PRIMARY KEY (`id`),
  KEY `idx_honor_id` (`honor_id`),
  KEY `idx_honor_user_id` (`flowers_user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='月度荣誉表';
